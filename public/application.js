...
var config = {
  apiOrigins: {
    production: 'https://sleepy-reef-72451.herokuapp.com',
...
var onAddTrip = function onAddTrip(event) {
  var data = getFormFields(this);
  $('#signInMessaging').text('');
  $('#trips-content').html('');
  $('#user-messages').text('');
  ...
  this.reset();
  // console.log(data)
  api.addTrip(data).then(ui.addTripSuccess).catch(ui.addTripFailure);
};

var onGetAllTrips = function onGetAllTrips(event) {
  $('#signInMessaging').text('');
  $('#trips-content').html('');
  $('#user-messages').text('');
  event.preventDefault();
  api.getAllTrips().then(ui.getAllTripsSuccess).catch(ui.getAllTripsFailure);
};

var onDeleteTrips = function onDeleteTrips(event) {
  ...
  api.deleteTrip(trip).then(ui.deleteTripSuccess).catch(ui.deleteTripFailure);
};
...
var onUpdateTrip = function onUpdateTrip(event) {
  ...
  api.updateTrip(data).then(ui.updateTripSuccess).catch(ui.updateTripFailure);
};

var onGetOneTrip = function onGetOneTrip(event) {
  $('#trips-content').html('');
  $('#signInMessaging').text('');
  $('#user-messages').text('');
  var data = getFormFields(event.target);
  ...
  api.getOneTrip(trip).then(ui.getOneSuccess).catch(ui.getOneFailure);
};
...
var addTrip = function addTrip(data) {
  // console.log(data)
  return $.ajax({
...
var deleteTrip = function deleteTrip(data) {
  // console.log(data)
  return $.ajax({
...
var getOneTrip = function getOneTrip(data) {
  // console.log(data)
  return $.ajax({
    url: config.apiOrigin + '/trips/' + data.id,
    method: 'GET',
...
var getAllTripsFailure = function getAllTripsFailure(error) {
  console.error(error);
  $('#user-messages').text('Uh Oh That didn\'t work, try again');
};
...
var getOneSuccess = function getOneSuccess(data) {
...
var getOneFailure = function getOneFailure(error) {
  console.error(error);
  $('#user-messages').text('Uh Oh That didn\'t work. Are you sure you have a trip with that id?');
};
...
module.exports = {
  ...
  addTripSuccess: addTripSuccess,
  addTripFailure: addTripFailure,
  getAllTripsSuccess: getAllTripsSuccess,
  getAllTripsFailure: getAllTripsFailure,
